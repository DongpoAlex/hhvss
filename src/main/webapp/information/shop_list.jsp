...
#grid_cat .aw-column-1,.aw-column-2,.aw-column-4 {
	width: 200px;
}
</style>
...
function init()
{
	...
	var url = "../DaemonInformation?focus=shop&timestamp=" + new Date().getTime();
...
{	
	...
	var columnNames = [ "门店编号", "门店名称", "上级门店", "门店类型", "地址", "电话" ];
...
<body onload="init()">
	<div id="title" align="left"
		style="font-size: 16px; font-family: '楷体_GB2312, 黑体'; color: #42658D; font-weight: bold";>门店清单:</div>
