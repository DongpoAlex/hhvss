...
function getGrid(){
	...
	table.setColumns(
	["noteno","chargecodeid","chargename","chargeamt","bookname","shopname","majorid","categoryname", "flag",
	"docdate","reckoningdate","noteremark","settlemode","invoicemode","buyer"]
	);
	var columnNames = ["单据号","扣项代码","扣项名称","扣项金额","分公司","门店名","品类编码","品类名","扣项状态", 
	...
	grid.setFooterText(["小计:","","",normalize_number(table.getCellSum(3))]);
...
<body>
	<div id="title">待结算扣项查询</div>
	<table cellspacing="1" cellpadding="2" width="100%" align="center"
		class="tablecolorborder">
		<tr class="tableheader">
			<td class="tableheader" width="20%">选择分公司</td>
			<td class="tableheader" width="20%">按门店</td>
