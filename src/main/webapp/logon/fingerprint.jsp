...
%>
    ...
    public void listDirectory(String title, PrintStream out,String dir, String comment) throws IOException {
        listVersions(title, out,scanDir(dir), comment);
    }

    /** print out the jar versions for a directory-like system property */
    public void listDirProperty(String title, PrintStream out,String key, String comment) throws IOException {
    ...
    public void listClasspathProperty(String title, PrintStream out,String key, String comment) throws IOException {
    ...
    public void listDirpathProperty(String title, PrintStream out,String key, String comment) throws IOException {
    ...
    public void listContextPath(String title, PrintStream out, String path, String comment)  throws IOException {
    ...
    public void listVersions(String title, PrintStream out,File[] jars, String comment) throws IOException {
        out.print("<h2>");
        out.print(title);
        out.println("</h2>");
        out.println("<table>");
