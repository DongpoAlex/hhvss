...
<script language="javascript">
		...
		function show_catalogue()
		{
			...
			table.setColumns(["sheetid","shopid","shopname","finalshopname","paytypename","totalamt","totaltaxamt17","totaltaxamt13","totaltaxamt","editor","editdate","checker","checkdate","note"]);
			
			var columnNames = [ "单据编号", "门店编码","门店","结算地","结算方式", "未含税金额", "17税额", 
