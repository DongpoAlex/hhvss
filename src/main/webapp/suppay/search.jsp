	...
	<div id="div0" class="search_main">
		...
		<div class="search_parms">
			单据状态:<select id="txt_status" name="txt_parms">
				...
				<option value="W">报批</option>
				<option value="G">审核</option>
				<!-- <option value="T">付款审核</option> -->
				<option value="I">付款中</option>
			</select>
		</div>
		<div class="search_parms">
			付款日期: <input type="text" id="txt_editdate_min" class="Wdate"
