	...
	<xsl:template name="output_head">
		...
		<table width="99%" cellspacing="0" cellpadding="2" border="1">
			...
			<tr>
				...
				<td>应提金额</td>
				<td class="num-fmt">
					<xsl:value-of select="format-number(ogdje,'#0.00')" />
				</td>
				<td>差异调整</td>
				<td class="num-fmt">
			...
			<tr>
				<td>独立促销</td>
				<td class="num-fmt">
					<xsl:value-of select="format-number(mgdje,'#0.00')" />
				</td>
				<td>差额提成</td>
				<td class="num-fmt">
					<xsl:value-of select="format-number(aqdje,'#0.00')" />
				</td>
				<td>实际提成</td>
				<td class="num-fmt">
					<xsl:value-of select="format-number(totdje,'#0.00')" />
				</td>
				<td>销售提成</td>
				<td class="num-fmt">
					<xsl:value-of select="format-number(n8,'#0.00')" />
				</td>
			</tr>
			<tr>
				<td>上次余额J</td>
		...
		<table width="99%" cellspacing="0" cellpadding="2" border="1">
			...
			<xsl:for-each select="row">
				<tr>
					...
					<td class="num-fmt">
						<xsl:value-of select="format-number(n2,'#0.00')" />
					</td>
					<td class="num-fmt">
						<xsl:value-of select="format-number(n8,'#0.00')" />
					</td>
		...
		<table width="99%" cellspacing="0" cellpadding="2" border="1">
			...
			<xsl:for-each select="row">
				<tr>
					...
					<!-- <td class="num-fmt"> <xsl:value-of select="format-number(calcbase,'#0.00')" 
						/> </td> <td class="num-fmt"> <xsl:value-of select="format-number(calcrate,'#0.00')" 
						/> </td> -->
					<td>
						<xsl:value-of select="rbillno" />
					</td>
					<td>
