		...
		<xsl:element name="table">
			...
			<xsl:for-each select="/xdoc/xout/sheetset/unpaidsheet_list/rows">
				...
				<xsl:element name="tr">
					...
					<xsl:element name="td">
						...
						<xsl:value-of
							select="format-number(number(paydocamt)+number(paytaxamt17)+number(paytaxamt13),'#,##0.00')" />
					</xsl:element>
					<xsl:element name="td">
						<xsl:attribute name="align">center</xsl:attribute>
			...
			<xsl:element name="tr">
				...
				<xsl:element name="td">
					...
					<xsl:attribute name="class">decimal</xsl:attribute>
					<xsl:if test="/xdoc/xout/sheetset/unpaidsheet_list/rows/paydocamt!=''">
						<xsl:value-of
							select="format-number(sum(/xdoc/xout/sheetset/unpaidsheet_list/rows/paydocamt)+sum(/xdoc/xout/sheetset/unpaidsheet_list/rows/paytaxamt17)+sum(/xdoc/xout/sheetset/unpaidsheet_list/rows/paytaxamt13),'#,##0.00')" />
					</xsl:if>
					<xsl:if test="/xdoc/xout/sheetset/unpaidsheet_list/rows/paydocamt=''">
						<xsl:value-of
							select="/xdoc/xout/sheetset/unpaidsheet_list/rows/paydocamt" />
					</xsl:if>
					<xsl:element name="td">
