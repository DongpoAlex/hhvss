...
<xml id="island4format" src="format4rentnote.xsl" />
<script>
...
{
	setLoading(true);
	var url = "../DaemonViewSheet?sheet=rentnote&sheetid=" + current_sheetid;
...
<body onload="init()">
	...
	<div align='center' style='font-size: 18px; font-weight: bold;';>联营租赁费用通知单</div>
	<br />
</body>
