...
function load_major(id){
	...
	ajax.response = function(text){
		...
		if(errCode==0){
			$("span_majorname").innerHTML = ajax.getXMLText("/xdoc/xout/sgroup/name");
		}else{
