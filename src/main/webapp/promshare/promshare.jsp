...
function search_report()
{
	...
	var url  = "../DaemonSearchSheet?sheetname=promshare&" + parms.join( "&" );
...
function downExcel(){
	...
	if( $("txt_sdate_min").value != '' ) parms.push( "sdate_min="+ $("txt_sdate_min").value );
	if( $("txt_sdate_max").value != '' ) parms.push( "sdate_max="+ $("txt_sdate_max").value );
	var url  = "../DaemonDownloadReport?reportname=prom&" + parms.join( "&" );
