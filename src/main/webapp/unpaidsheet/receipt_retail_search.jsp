...
<script type="text/javascript">
		...
		function getGrid(){
			...
			table.setColumns(
			["bookname", "shopid", "shopname", "majorid","categoryname","logisticsid","paytypename","docdate","sheetid","unpaidamt","payflag","note"]
			);	
			var columnNames = ["分公司", "门店编码", "门店名称", "课类编码","课类名称","物流模式","结算方式","发生日期","单据编码","金额（含税）","状态","备注"]
...
<body>
	...
	<table cellspacing="1" cellpadding="2" width="100%" align="center"
		...
		<tr class="tableheader">
			...
			<td class="tableheader" width="15%">根据供应商编码(必填)<span
				style="color: red; font: bold">*</span>
			</td>
			<td class="tableheader" width="20%">根据单据编码</td>
