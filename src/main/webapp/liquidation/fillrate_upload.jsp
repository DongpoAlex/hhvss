...
function upload(){
	try{
		...
		Arr_FieldName.push("sheetid");
		Arr_FieldName.push("refsheetid");
		Arr_FieldName.push("recvsheetid");
		Arr_FieldName.push("majorid");
		Arr_FieldName.push("shopid");
		Arr_FieldName.push("desshopid");
		Arr_FieldName.push("goodsid");
		Arr_FieldName.push("barcode");
		Arr_FieldName.push("qty");
		Arr_FieldName.push("recvqty");
		Arr_FieldName.push("cost");
		Arr_FieldName.push("recvcost");
		Arr_FieldName.push("costrate");
		Arr_FieldName.push("recvdate");
		
		var uploader = new AjaxMatrix( "../DaemonUpload?sheetname=fillrate&operation=upload",Arr_FieldName,txt_source.value);
...
<body>
	...
	<div>
		使用说明：<br /> 编辑一个EXCEL文档，按照，上面的字段顺序填写好数据，然后粘贴到文本框内。<br /> <font
			color="red">注意：请在导入数据的时候把满足率的百分号去掉！每次最多上传10000行数据！</font>
	</div>
</body>
</html>
