...
function search_report()
{
	...
	if( $("txt_xm").value != '' ) parms.push( "xm="+ ($("txt_xm").value) );
	...
	var courier = new AjaxCourier( encodeURI(url) );
...
<body onload="init()">
	...
	<table cellspacing="1" cellpadding="2" width="100%" align="center"
		...
		<tr class="tableheader">
			<td class="tableheader" width="25%">输入促销门店(例：华强促销)</td>
			<td class="tableheader" width="20%">考勤卡号</td>
			<td class="tableheader" width="30%">刷卡日期</td>
			<td class="tableheader">查询</td>
		</tr>
		<tr>
			<td class="altbg2"><input type="text" id="txt_xm" /></td>
