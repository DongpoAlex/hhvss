...
function getGrid(){
	...
	table.setColumns(
	["venderid","shopid","shopname",  "barcode", "goodsid","goodsname","categoryid","categoryname",
	"unitname","spec", "goodsstatus", "logistics", "costtaxrate"]
	);	
	var columnNames = ["供应商","门店编码","门店名称", "商品条码","商品编码","商品名称","小类编码", "小类名称", 
...
<body>
	<div id="title">供应商供货商品清单-明细－零售商</div>
