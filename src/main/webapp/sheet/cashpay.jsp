...
<body>
	...
	<div id="div0" class="search_main">
		...
		<div class="search_parms">
			收款日期: <input type="text" id="txt_editdate_min" class="Wdate"
		...
		<div class="search_parms">
			单号: <input type="text" id="txt_sheetid" size="20" name="txt_parms" />
		</div>
