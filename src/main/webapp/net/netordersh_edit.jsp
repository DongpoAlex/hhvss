...
<script language="javascript" src="./netordersh_edit.js"></script>
<style>
.aw-column-0 {
	width: 80px;
	cursor: pointer;
...
<title>网上特殊预约修改</title>
</head>
<body onload="init('<%=order_serial%>','<%=dccode%>')">
	<div id="divTitle">网上特殊预约修改</div>
	...
	<div id="div_ordersh">
		...
		<div style="margin-bottom: 10px;">
			供应商编码：<input type="text" size="20" maxlength="20"
				id="txt_supplier_no"></input>--<input type="text" size="20"
				maxlength="20" id="txt_vendername"></input>&nbsp;&nbsp;
		</div>
		<div style="margin-bottom: 10px;">
		...
		<div style="margin-bottom: 10px;">
			<input type="button" onclick="addorderpo()" value="加单" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input
				type="button" onclick="delorderpo()" value="减单" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
