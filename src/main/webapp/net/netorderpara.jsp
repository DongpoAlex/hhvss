...
<script language="javascript" src="./netorderpara.js">
</script>
<style>
.aw-column-0,.aw-column-1,.aw-column-2,.aw-column-4,.aw-column-5,.aw-column-6,.aw-column-7,.aw-column-8,.aw-column-9,.aw-column-10,.aw-column-11,.aw-column-12
	{
	width: 80px;
	text-align: center
}
	...
	<table cellspacing="1" cellpadding="2" width="98%"
		...
		<tr>
			<td class="altbg2">DC:<%=shop%>&nbsp;&nbsp;&nbsp;&nbsp; <input
				...
				class="button" value="新增" type="button" onclick="add()" /></td>
		</TR>
	</table>
