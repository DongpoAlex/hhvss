...
function getGrid(){
	...
	table.setColumns(
	["shopid","shopname","goodsid", "barcode","goodsname", "qty", "releasedate"]
	);
	var columnNames = [	"门店编码","门店名称", "商品编码","商品条码","商品名称","库存数量","发布日期"]
	...
	grid.setCellFormat( [ str, str,num2,num2, str, num ] );
	grid.setCellModel(table);
	grid.setFooterText(["小计:","","","","",table.getCellSum(5)]);
