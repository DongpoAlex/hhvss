...
<script language="javascript">
		...
		{
			table4search.setColumns( [ "sheetid", "statusname", "rettype","shopid", "shopname","shopname","cost", 
			 "retdate", "operator", "editor", "editdate", "retchecker", "retcheckdate" ] );
		
			var columnNames = [ "单据号", "状态", "退货类型","门店", "门店名称","申请地","退货金额",
