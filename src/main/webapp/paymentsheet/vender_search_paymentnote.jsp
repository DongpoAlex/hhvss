...
<%
	...
	SelPayShop sel_payshop = new SelPayShop(token);
...
function display_catalogue()
{
	...
	table.setColumns(["ccc","sheetid","aaa","bbb","ccc","flag","chargeamt","payamt","planpaydate",
	...
	obj_export.setEvent( "onclick",
        	function(){
        		var current_row = grid.getCurrentRow();
        		var sheetid = grid.getCellValue( 1, current_row );
        		var url = "../DaemonDownloadPayment?sheetname=paymentsheet&sheetid=" + sheetid;
...
function post_req()
{
	...
	var url = "../DaemonSheetManager?sheetname=paymentsheet&operation=req&" + array_selected.join("&");
...
<body onload="init();">
	...
	<table cellspacing="1" cellpadding="2" width="98%"
		...
		<tr class="tableheader">
			<td class="tableheader" width="20%">结算公司</td>
		...
		<tr id="header0_toggle" style="display: block">
			<td class="altbg2"><%=sel_payshop %></td>
			<td class="altbg2"><select id="txt_flag" name="txt_flag">
					...
					<option value="6">付款确认</option>
					<option value="7">网银已支付</option>
			</select></td>
