...
{	
	var parms = new Array();
	if( $("txt_payshopid").value != "" ) 	        parms.push( "payshopid=" + $("txt_payshopid").value );
...
function display_catalogue()
{
	...
	table.setColumns(["sheetid","aaa","venderid","vendername","flagname","chargeamt","payamt","planpaydate",
	        "paydate","editor","flag","reqflag","reqdate","sjflag","sjprintdate"]);
...
function downExcel(){
	...
	var url  = "../DaemonDownloadExcel?operation=paymentsheetlist&" + parms.join( "&" );
