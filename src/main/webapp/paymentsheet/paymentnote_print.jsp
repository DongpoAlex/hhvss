...
function showAll(){
	setLoading(true);
	var url = "../DaemonShowPayment?sheetname=paymentsheet&section=all&sheetid=" + sheetid;
...
function showAllGroupByshop(){
	setLoading(true);
	var url = "../DaemonShowPayment?sheetname=paymentsheet&section=allgroupbyshop&sheetid=" + sheetid;
	var courier = new AjaxCourier( url );
	courier.reader.read 	= function(text){
	//alert(text)
		setLoading(false);
...
function showAllGroupByCharge(){
	setLoading(true);
	var url = "../DaemonShowPayment?sheetname=paymentsheet&section=allgroupbycharge&sheetid=" + sheetid;
	var courier = new AjaxCourier( url );
	courier.reader.read 	= function(text){
		//alert(text)
		setLoading(false);
...
<body onload="init()">
	...
	<span id="toPrint"> <a href="javascript:showPrint();">[打印本页]</a>
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a
		href="javascript:showAllGroupByCharge()">[ 汇总打印 ]</a>
	</span>
