...
package com.royalstone.util.barcode;
    ...
    implements Serializable
{
	 ...
	 * 
	 */
	private static final long	serialVersionUID	= 3155586346400646566L;
    ...
    protected void vbnm(Graphics g)
    {
        ...
        g.setColor(barColor);
        g.drawString("power by baij", rTy + 5, i + 5);
    }
