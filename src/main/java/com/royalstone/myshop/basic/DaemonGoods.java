 ...
 * @author baijian
 */
public class DaemonGoods extends XDaemon
{
	...
	public void doGet( HttpServletRequest request, HttpServletResponse response ) throws ServletException, IOException
	{
		...
		try {
            ...
            if( barcode == null || barcode.length() == 0 ) throw new InvalidDataException( "barcodeid not set! " );
            
            Look4Goods info = new Look4Goods( conn, barcode );
