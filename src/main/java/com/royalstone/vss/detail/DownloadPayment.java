...
public class DownloadPayment 
{
	 ...
	 */
	public DownloadPayment( Connection conn, String sheetid,Token token ) throws SQLException, InvalidDataException 
	{
		this.conn = conn;
	...
	public void getHead() throws SQLException, InvalidDataException
	{
		...
		String[] title = {"单据编号", "城市公司", "支付方式", "本期对帐金额", "计划付款日期", "17%税建议开票金额", "13%税建议开票金额"};
		String sql = " SELECT "
