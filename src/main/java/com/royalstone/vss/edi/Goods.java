...
public class Goods implements IEdiSheet {
	...
	public Goods(Item item, String venderid, Connection conn) {
		super();
	...
	public void export(String venderid) throws SQLException, IOException, InvalidDataException {
		...
		String fileName = "CRV-"+venderid+"-"+Worker.SDF_Y4MD.format(cal.getTime())+"-ProductTable.txt";
		// 创建文件
	...
	private ArrayList<String> getItem(String sheetid) throws SQLException {
		...
		String sql_detail = " select barcodeid, goodsid, goodsname, sgroupid, sgroupname, deptid, deptname, brandid, brandname, goodsspec, bpackagespec, qadays, venderid from edi_goodsinfo_bg where venderid='"+this.venderid+"'";
	...
	private void toBAK(String venderid) {
		String sql = "delete from edi_goodsinfo_bg where 1=1 ";
