...
public class SaleDept implements IEdiSheet {
	...
	public SaleDept(Item item, String venderid, Connection conn) {
		super();
	...
	public void export(String venderid) throws SQLException, IOException, InvalidDataException {
		...
		for (String date : list) {
			String fileName = "CRV-"+venderid+"-"+date+"-CategorySales.txt";
			// 创建文件
	...
	private List<String> getDateList(){
		String sql = "SELECT DISTINCT to_char(sdate,'yyyyMMdd') FROM EDI_SGROUPSALE_BG";
	...
	private void exportItem(String sheetid,String filePatch,String date) throws SQLException {
		String sql_detail = " select a.sgroupid,a.sgroupname,a.deptid,a.venderid,a.shopid,to_char(a.sdate,'yyyyMMdd'),a.promtype,a.tuan," +
				" a.dmid,a.salevalue,a.maoli, a.stockcostv "
				+ " from EDI_SGROUPSALE_BG a  where  a.venderid=?  and sdate=to_date(?,'yyyyMMdd') order by a.sdate,a.shopid,a.deptid";
	...
	private void toBAK(String venderid) {
		String sql0 = "delete from EDI_SGROUPSALE_BG_BAK  a where  a.sdate < sysdate-7  and a.venderid='" + venderid  + "' ";
		String sql1 = "delete from EDI_SGROUPSALE_BG_BAK  a where (a.sdate,a.venderid) in (select sdate,venderid from EDI_SGROUPSALE_BG where venderid='"+venderid+"')";
		String sql2 = "insert  into  EDI_SGROUPSALE_BG_BAK select * from EDI_SGROUPSALE_BG where venderid='" + venderid + "' ";
		String sql3 = "delete from EDI_SGROUPSALE_BG where venderid='" + venderid + "'  ";
